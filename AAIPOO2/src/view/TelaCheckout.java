...
public class TelaCheckout {
    ...
    private VBox criarConteudo() {
        ...
        listaReservas.setStyle("-fx-font-family: Arial; -fx-font-size: 14px; -fx-background-radius: 6;");
        
        carregarReservas();
        
        // Custom cell factory para melhorar o visual da lista
        listaReservas.setCellFactory(param -> new ListCell<Reserva>() {
            ...
            protected void updateItem(Reserva r, boolean empty) {
                ...
                if (empty || r == null) {
                    ...
                    lbl1.setTextFill(Color.web("#2C3E50"));
                    
                    Label lbl2 = new Label(r.getDataCheckin() + " até " + r.getDataCheckout() + " (" + r.getDiarias() + " diárias)");
                    lbl2.setFont(Font.font("Arial", 12));
                    lbl2.setTextFill(Color.web("#7F8C8D"));
        ...
        btnAtualizar.setStyle("-fx-background-color: transparent; -fx-border-color: #BDC3C7; -fx-border-radius: 4; -fx-cursor: hand;");
        ...
        btnAvancar.setStyle("-fx-background-color: #2980B9; -fx-text-fill: white; -fx-padding: 10 20; -fx-background-radius: 6; -fx-cursor: hand;");
